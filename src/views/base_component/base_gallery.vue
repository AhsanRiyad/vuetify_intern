      ...
      <v-container fluid>
        <v-row>
          ...
          <v-card flat tile class="d-flex">
            <v-img
            :src="  $store.getters.getModelAddress_laravel+photo.group_photo  "
            :lazy-src="  $store.getters.getModelAddress_laravel+photo.group_photo   "
            
            @click=" ( dialog1 = true ) , ( dialog_photo =  $store.getters.getModelAddress_laravel+photo.group_photo  ) , ( photo_base_name = photo.group_photo ) "

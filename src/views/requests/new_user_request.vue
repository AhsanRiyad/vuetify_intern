...
<script>
  ...
  export default {
    ...
    { text: 'Time', value: 'registration_date' },
    { text: 'Details', value: 'user_details', align: 'center', },
    { text: 'Accept', value: 'accept_new_user', align: 'center', },
    { text: 'Reject', value: 'reject_new_user', align: 'center', }
    ],

...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2020 at 06:11 AM
...
CREATE TABLE `privacy` (
  ...
  `bangla_name` tinyint(1) DEFAULT 1,
  ...
  `mothers_name` tinyint(1) DEFAULT 0,
...
(1, 'riyad298@gmail.com', '2408', 'ac627ab1ccbdb62ec96e702f07f6425b', 'approved', 'verified', 'rejected', '2019-11-29 01:45:23.000000', 'admin', 'full_name,mobile,institution_id,mother_name,spouse_name,profession,institution,present_district,membership_number,status,email_verification_status,change_request', 100, '\r\n'),
...
(6, 'abcd@abcd.com', '9250', NULL, 'not_verified', 'not_verified', 'not_requested', NULL, 'user', 'full_name,institution_id,membership_number', 60, NULL);
